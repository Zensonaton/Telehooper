...
async def Connect(msg: MessageType) -> MessageType:
	return await ConnectMessage(msg)

async def ConnectMessage(msg: MessageType, edit_message_instead: bool = False) -> MessageType:
...
async def ConnectCallbackHandler(query: CallbackQuery):
