...
FAQ_INFO = {
	...
	"5. Начало работы с ботом": (
		...
		"  4. Пропишите команду <code>/this</code> для преобразования группы в диалог сервиса.\n"
		"  5. Прочитайте предупреждение и подтвердите действие преобразования группы.\n"
		"  6. Выберите нужный сервис, а потом диалог из этого сервиса. Если Вы потеряли сообщение, то снова пропишите <code>/connect</code>.\n"
		"\n"
