...
FAQ_INFO = {
	...
	"5. Начало работы с ботом": (
		...
		"\n"
		"Если всё будет в порядке, то нужный Вам сервис будет подключен к Telehooper, и Вы сможете увидеть это подключение в команде /me.\n"
		"\n"
		...
		"  2. Добавьте в группу бота Telehooper..\n"
		"  3. Дайте боту права администратора.\n"
		"  4. Следуйте отправленными ботами инструкциям, либо же, как альтернатива, используйте команду <code>/this</code>.\n"
