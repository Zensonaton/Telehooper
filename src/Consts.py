...
SETTINGS = {
	"Visual": {
		...
		"UsePinInDialogues": {
			...
			"Documentation": (
				...
				"  • <b>имя</b> пользователя,\n"
				"  • статус <b>«прочитано»</b> у последнего отправленного сообщения.\n"
				"\n"
	...
	"Security": {
		...
		"StoreTokens": {
			...
			"Documentation": (
                "Указывается, может ли Telehooper хранить токены авторизации <a href=\"https://dev.vk.com/api/access-token/getting-started\"><i>[Документация ВК]</i></a> в его базе данных для автоматического процесса восстановления сессий сервисов после перезагрузок.\n"
				"\n"
